...
namespace BZY.OA.Common.Cache
{
    ...
    public class RedisCache : ICache
    {
        ...
        public T GetCache<T>(string cacheKey) where T : class
        {
            try
            {
                return RedisCacheHepler.Get<T>(SystemInfo.CachePrefix + cacheKey);
            }
            catch
            {
                return null;
        ...
        {
            RedisCacheHepler.Set(SystemInfo.CachePrefix + cacheKey, value, expireTime);
        }
        ...
        {
            RedisCacheHepler.Remove(SystemInfo.CachePrefix + cacheKey);
        }
        ...
        {
            RedisCacheHepler.RemoveByPattern(SystemInfo.CachePrefix + pattern);
        }        
